...
function App() {
  ...
  // without Content-Type, flask cannot find body
  // without Access-Control-Allow-Origin, will cause CORS error
  const headers = {
  ...
  useEffect(()=>{
    const call_api = async() => {
      ...
      // update ai message
      setChatLog([...chatLog, {user: "ai", message: `${data}`}])
      setIsLoading(false)
    }
  ...
  async function handleSubmit(e) {
    ...
    // they will update after function complete
    setMessage(input)
    ...
    <section className="chatbox">
      ...
      <div className="chat-input-holder">
        <form onSubmit={handleSubmit}>
          ...
          className="chat-input-textarea" rows="1">
